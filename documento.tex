...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=1.5cm]
        % Define the layers
        \node[rectangle, minimum width=12cm, minimum height=1.5cm, fill=blue!20, draw] (ui) {Frontend (NEXTJS)};
        ...
        \node[rectangle, minimum width=12cm, minimum height=1.5cm, fill=gray!20, draw, below=0.5cm of db] (infra) {Infraestructura (Podman/Podman Compose)};
