...
async fn main() -> std::io::Result<()> {
    ...
    client_options.write_concern = Some(WriteConcern::builder()
    ...
    client_options.selection_criteria = Some(ReadPreference::SecondaryPreferred { options: Some(options) }.into());
